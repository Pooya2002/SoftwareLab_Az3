...
<td>
<p>برای سرویس ها این نکته رعایت نشده. چرا که اولا هر کلاسی دارد دو تا سرویس مجزا (validation و send) را انجام می دهد و لذا دو دلیل مختلف برای تغییر این فایل ها وجود دارد. در ضمن، طراحی بد کد(وجود سه تابع در رابط) باعث شده که حتما هر کلاسی حتی برای توابعی که خودشان پیاده سازی نمی کنند، آن تابع را خالی بگذارند. </p>
</td>
</tr>
<tr>
<td rowspan="2">
